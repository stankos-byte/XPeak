...
const LandingView: React.FC<LandingViewProps> = ({ onGetStarted }) => {
  const navLinks = ['HOME', 'FEATURES', 'FAVORITES', 'SOLUTION', 'FAQS'];
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center gap-6">
              {navLinks.map((link) => (
                <a
                  ...
                  className="text-secondary/80 hover:text-white transition-colors text-sm font-medium uppercase tracking-wider"
                >
                  {link}
                </a>
              ))}
          ...
          {onGetStarted && (
            <button
              ...
              className="inline-flex items-center gap-2 bg-white hover:bg-gray-100 text-background px-6 py-3 rounded-full font-bold text-sm transition-all shadow-lg hover:shadow-xl"
            >
              <Download size={16} />
              Download App
            </button>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="inline-block px-4 py-2 bg-surface/80 border border-primary/30 rounded-full mb-6">
                <span className="text-primary text-xs font-bold uppercase tracking-wider">New Feature</span>
              </div>
