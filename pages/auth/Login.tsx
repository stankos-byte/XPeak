...
import { signInWithEmailAndPassword, signInWithPopup, GoogleAuthProvider, OAuthProvider, updateProfile } from 'firebase/auth';
import { auth } from '../../config/firebase';
import { getUser, createUserDocument } from '../../services/firestoreService';
...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      gameToast.success('Welcome back!');
      navigate('/app');
    } catch (error: any) {
