...
import { Swords, Zap, Target, TrendingUp, Sparkles, ArrowRight, Play, Facebook, Twitter, Instagram, Linkedin, Youtube } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          {onGetStarted && (
            <button
              ...
              className="hidden md:inline-flex items-center gap-2 bg-primary hover:bg-cyan-400 text-background px-6 py-3 rounded-xl font-bold uppercase tracking-wide text-xs transition-all shadow-lg shadow-primary/20 hover:shadow-primary/40"
            >
              Get Started
              <ArrowRight size={16} />
            </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="lg:col-span-1">
              ...
              <p className="text-secondary/80 text-sm leading-relaxed mb-6">
                Transform your life into a game. Level up your skills, complete quests, and achieve your goals with gamified productivity.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <a href="#" className="text-secondary/80 hover:text-primary transition-colors text-sm">Feedback</a>
                </li>
              </ul>
            </div>
